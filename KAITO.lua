...
io.popen("cd library && wget https://raw.githubusercontent.com/TEAM-KAITO/KAITO/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAM-KAITO/Files_KAITO/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKAITOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "TEAMKAITO")
...
local KAITO_Msg = ''  
if msgs < 100 then 
KAITO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KAITO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KAITO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KAITO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KAITO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KAITO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KAITO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KAITO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KAITO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KAITO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KAITO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KAITO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KAITO_Msg = 'رب التفاعل'  
end 
return KAITO_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@TTITITl")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKAITO(msg,data) -- بداية العمل 
if msg then
...
local list = database:smembers(bot_id.."KAITO1:List:Filter"..sl)
...
if not DevKAITOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKAITOW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,KAITO_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⊀' and DevKAITOW(msg) then  
...
if text == 'تعطيل التواصل ⊀' and DevKAITOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⊀' and DevKAITOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⊀' and DevKAITOW(msg) then  
...
if text == 'ضع كليشه ستارت ⊀' and DevKAITOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⊀│ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⊀' and DevKAITOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⊀│تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⊀' and DevKAITOW(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⊀│[تحديثات البوت](t.me/TEAMKAITO) \n⊀│[قناه السورس](t.me/TEAMKAITO)')
end
if text == "ضع اسم للبوت ⊀" and DevKAITOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⊀│ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⊀' and DevKAITOW(msg) then 
...
if text == 'المشتركين ⊀' and DevKAITOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⊀│المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⊀' and DevKAITOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⊀│الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⊀") and DevKAITOW(msg) then
...
if text == ("قائمه العام ⊀") and DevKAITOW(msg) then
...
if text == ("قائمه الكتم العام ⊀") and DevKAITOW(msg) then
...
if text=="اذاعه خاص ⊀" and msg.reply_to_message_id_ == 0 and DevKAITOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⊀│ارسل الان اذاعتك؟* \n*⊀│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⊀" and msg.reply_to_message_id_ == 0 and DevKAITOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⊀│ارسل الان اذاعتك؟* \n*⊀│للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⊀" and msg.reply_to_message_id_ == 0 and DevKAITOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⊀│ارسل الان اذاعتك؟* \n*⊀│للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⊀" and msg.reply_to_message_id_ == 0  and DevKAITOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⊀│ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⊀" and msg.reply_to_message_id_ == 0  and DevKAITOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⊀│ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⊀' and DevKAITOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⊀" and DevKAITOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⊀" and DevKAITOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⊀│عدد الكروبات الان » { '..#group..' }'..KAITOk..''..KAITO..'*\n*⊀│الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKAITOW(msg) then
...
usertext = '*\n ⊀│اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'TEAMKAITO')..')'
status  = '\n *⊀│تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKAITOW(msg) then
...
usertext = '\n *⊀│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
status  = '\n*⊀│تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKAITOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKAITOW(msg) then
...
local KAITO1_Msg = database:get(bot_id.."KAITO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KAITO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⊀│اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAMKAITO')..') \n ⊀│'..KAITO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KAITO_Msg and not Special(msg) then  
local KAITO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KAITO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⊀│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⊀│["..KAITO_Msg.."] \n")
else
send(msg.chat_id_,0," *⊀│العضو :* {["..data.first_name_.."](T.ME/TEAMKAITO)}\n⊀│["..KAITO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⊀│عذرا ⇎* {["..data.first_name_.."](T.ME/TEAMKAITO)}\n*⊀│عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKAITOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKAITOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKAITOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⊀│حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKAITOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⊀│حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⊀" and DevKAITOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⊀│تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⊀$") and DevKAITOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⊀│حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⊀" and DevKAITOW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⊀" and DevKAITOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⊀│تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⊀" and DevKAITOW(msg) then  
...
database:sadd(bot_id.."KAITO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KAITO:blocname"..msg.chat_id_)
...
function TTITITl_name(t1,t2)
if t2.id_ then 
name_KAITO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KAITO then 
names_KAITO = database:smembers(bot_id.."KAITO:blocname"..msg.chat_id_) or ""
if names_KAITO and names_KAITO[1] then 
for i=1,#names_KAITO do 
if name_KAITO:match("(.*)("..names_KAITO[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, TTITITl_name)
end
...
database:set(bot_id.."KAITO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KAITO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KAITO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KAITO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KAITO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KAITOa_new(KAITO1,KAITO2)
if KAITO2 and KAITO2.first_name_ then 
if KAITO2.first_name_:match("(.*)"..database:get(bot_id.."KAITO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KAITO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KAITO_nnn = database:get(bot_id.."KAITO:nump"..msg.chat_id_) or 5
local KAITO_nnn2 = database:get(bot_id.."KAITO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KAITO_nnn2) == tonumber(KAITO_nnn) or tonumber(KAITO_nnn2) > tonumber(KAITO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KAITO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⊀│عزيزي >>["..KAITO2.username_.."](https://t.me/"..(KAITO2.username_ or "TEAMKAITO")..")\n⊀│عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KAITO:teh"..msg.chat_id_).."} بجانب اسمك\n⊀│عدد المحاولات المتبقيه {"..(tonumber(KAITO_nnn) - tonumber(KAITO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KAITOa_new)
end
end
...
local KAITOChengName = database:get(bot_id.."KAITO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KAITOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KAITOChengName..']')
database:del(bot_id.."KAITO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KAITOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KAITO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KAITOChengUserName = database:get(bot_id.."KAITO:Cheng:UserName"..data.id_)
if not data.username_ then 
if KAITOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KAITOChengUserName..']')
database:del(bot_id.."KAITO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KAITOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KAITO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
get_msg = database:get(bot_id.."msg:match:"..msg.sender_user_id_..":"..msg.chat_id_) or 0
send(msg.chat_id_, msg.id_,"*⊀│عدد رسائلك الكلي اليوم هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
send(msg.chat_id_, msg.id_,"*⊀│عدد رسائل الشخص الكلي اليوم هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KAITOChengPhoto = database:get(bot_id.."KAITO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KAITOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KAITO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KAITOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KAITO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevKAITOW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '*⊀│بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAMKAITO')..') \n*⊀│تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⊀│بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEAMKAITO')..') \n*⊀│تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == 'تحديث' and DevKAITOW(msg) then
dofile('KAITO.lua')  
send(msg.chat_id_, msg.id_, ' *⊀│تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKAITOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKAITOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if KAITOSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevKAITOW(msg) then
...
if KAITOSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⊀│لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevKAITOW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKAITOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevKAITOW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevKAITOW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKAITOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevKAITOW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevKAITOW(msg) then
...
if text == ("مسح المطورين") and DevKAITOW(msg) then
...
if database:get(bot_id.."TTITITl:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'TTITITl:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevKAITOW(msg) then
t = ' *⊀│ملفات السورس كايتو ↓*\n*☾•━━━━━━ 𝙆𝙄 ━━━━━━━•☽* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n ︙اهلا بك في متجر ملفات كايتو\n ︙ملفات السورس ↓\n ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ \n\n"
local TextE = "\n ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ \n ︙علامة تعني { ✔️ } ملف مفعل\n ︙علامة تعني { ✖ } ملف معطل\n ︙قناة سورس كايتو ↓\n".." ︙[اضغط هنا لدخول](t.me/VAAVVVV) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAM-KAITO/Files_KAITO/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('KAITO.lua')  
else
send(msg.chat_id_, msg.id_," ︙عذرا الملف لايدعم سورس كايتو \n") 
end
return false
end
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKAITOW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKAITOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "TEAMKAITO")
...
function Function_KAITO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KAITO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KAITO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⊀│العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
status  = '\n*⊀│تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⊀│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
status  = '\n*⊀│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⊀│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⊀│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
...
local TexKAITO = {string.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexKAITO[3] == 'يوم' then
Time_Restrict = TexKAITO[2]:match('(%d+)')
Time = Time_Restrict * 86400
end
if TexKAITO[3] == 'ساعه' then
Time_Restrict = TexKAITO[2]:match('(%d+)')
Time = Time_Restrict * 3600
end
if TexKAITO[3] == 'دقيقه' then
Time_Restrict = TexKAITO[2]:match('(%d+)')
Time = Time_Restrict * 60
end
TexKAITO[3] = TexKAITO[3]:gsub('دقيقه',"دقايق") 
TexKAITO[3] = TexKAITO[3]:gsub('ساعه',"ساعات") 
TexKAITO[3] = TexKAITO[3]:gsub("يوم","ايام") 
if KAITOSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⊀│لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⊀│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
status  = '\n*⊀│تم كتم لمدة ~* { '..TexKAITO[2]..' '..TexKAITO[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TexKAITO[4]}, start_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
local TexKAITO = {string.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexKAITO[3] == 'يوم' then
Time_Restrict = TexKAITO[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⊀│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
status  = '\n*⊀│تم تقيده لمدة ~* { '..TexKAITO[2]..' '..TexKAITO[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
database:set(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⊀│ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KAITO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KAITO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⊀│تم منع الكلمه مع التحذير*")  
database:del(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KAITO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KAITO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KAITO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⊀│ارسل الكلمه الان*")  
database:set(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KAITO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KAITO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KAITO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KAITO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KAITO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KAITO1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevKAITOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⊀│تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKAITOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⊀│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'TEAMKAITO')..')'..'\n*⊀│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKAITOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKAITOW(msg) then  
...
if not database:get(bot_id..'TTITITl:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'TTITITl:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."TTITITl:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and Manager(msg) then  
local list = database:smembers(bot_id.."TTITITl:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "*⊀│تم مسح "..k.." من الوسائط الموجوده*"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."TTITITl:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."TTITITl:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كايتو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كايتو')
local KAITO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..KAITO_Msg[math.random(#KAITO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKAITOW(msg) then 
...
if KAITOSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevKAITOW(msg) then 
...
if text == ("ردود المطور") and DevKAITOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⊀│قائمة ردود المطور \n*☾•━━━━━━ 𝙆𝙄 ━━━━━━━•☽*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKAITOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevKAITOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevKAITOW(msg) then   
...
if text == 'تعطيل المغادره' and DevKAITOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMKAITO')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KAITOdx(msg.chat_id_, msg.id_, ' *⊀│ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⊀│عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⊀│عدد المحظورين » ( '..data.kicked_count_..' )*\n*⊀│عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKAITOW(msg) then
...
{{text = '❼', callback_data="/help7"},{text = '❽', callback_data="/help8"},{text = '❾', callback_data="/help9"}},
{{text = '❿', callback_data="/help10"}},
{{text = '𓅛 𝙏𝙀𝘼𝙈 𝙆𝘼𝙄𝙏𝙊', url="t.me/TEAMKAITO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𓅛 𝙏𝙀𝘼𝙈 𝙆𝘼𝙄𝙏𝙊', url="t.me/TEAMKAITO"}},
{{text = 'مطـور السـورس', url="t.me/TTITITl"}},
}
send_inlin_key(msg.chat_id_," *⊀│قائمه بلاي اضغط للعب*",_key,msg.id_)
else
send(msg.chat_id_, msg.id_," *⊀│بلاي معطله في الوقت الحالي .*")
end
end
...
send(msg.chat_id_, msg.id_, t..'ٴ⊀∫ٴ*☾•━━━━━━ 𝙆𝙄 ━━━━━━━•☽*ٴ⊀∫○ٴ\n⊀│[𝙏𝙀𝘼𝙈 𝙆𝘼𝙄𝙏𝙊](t.me/TEAMKAITO) ')
end
...
local Text ='*⊀│عمري تم اختيار المقطع الصوتي لك💞🎶*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⊀ 𝙏𝙀𝘼𝙈 𝙆𝘼𝙄𝙏𝙊',url="t.me/TEAMKAITO"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "راسلني" then
send(msg.chat_id_, msg.id_,' *⊀│باع الخاص حبي بس لا تكول عني زاحفا 🙈🌸*') 
...
inline = {
{{text = '𓅛 sᴏᴜʀᴄᴇ ᴛʀᴇɴᴅ',url='http://t.me/TEAMKAITO'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كايتو')
...
KAITO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KAITO)
...
--------------------------------------------------------------------------------------------------------------
SourceKAITO(data.message_,data)
...
------------------------------------------------------------------------
local KAITOAbot = database:get(bot_id.."KAITO1:Add:Filter:Rp2"..text..result.chat_id_)   
if KAITOAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⊀│العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⊀│["..KAITOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KAITO1_Msg = database:get(bot_id.."KAITO1:Add:Filter:Rp2"..text..result.chat_id_)   
if KAITO1_Msg then
send(msg.chat_id_, msg.id_," ⊀│"..KAITO1_Msg)
